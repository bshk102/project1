...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2021-04-21');
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    return item.addEventListener('input', function () {
      return item.value = item.value.replace(/\D/, '');
    });
  });
};
...
var forms = function forms(state) {
  ...
  var message = {
    loading: 'Загрузка',
    sucsess: 'Спасибо! Скоро мы с вами сяжемся',
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMessage.textContent = message.fail;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
